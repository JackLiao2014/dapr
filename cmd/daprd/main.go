...
import (
	...
	"github.com/dapr/components-contrib/middleware/http/respuppercase"
...
func main() {
	...
	err = rt.Run(
		...
		runtime.WithHTTPMiddleware(
			...
			http_middleware_loader.New("respuppercase", func(metadata middleware.Metadata) (http_middleware.Middleware, error) {
				return respuppercase.NewRespUpperCaseMiddleware(log).GetHandler(metadata)
			}),
		),
	)
	if err != nil {
